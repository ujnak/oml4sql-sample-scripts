...
BEGIN
  ...
  v_setlst('RALG_BUILD_FUNCTION')   := 'NN_RDEMO_BUILD_REGRESSION';
  v_setlst('RALG_SCORE_FUNCTION')   := 'NN_RDEMO_SCORE_REGRESSION';
  v_setlst('RALG_DETAILS_FUNCTION') := 'NN_RDEMO_DETAILS_REGRESSION';
...
BEGIN
  -- Model Settings -----------------------------------------------------------
  v_setlst('ALGO_EXTENSIBLE_LANG')  := 'R';
  v_setlst('RALG_BUILD_FUNCTION')   := 'NN_RDEMO_BUILD_CLASSIFICATION';
  v_setlst('RALG_SCORE_FUNCTION')   := 'NN_RDEMO_SCORE_CLASSIFICATION';
  v_setlst('RALG_DETAILS_FUNCTION') := 'NN_RDEMO_DETAILS_CLASSIFICATION';
  v_setlst('RALG_WEIGHT_FUNCTION')  := 'NN_RDEMO_WEIGHT_CLASSIFICATION';
